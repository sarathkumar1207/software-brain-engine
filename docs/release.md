...
| Platform | Artifact |
| --- | --- |
| Windows x64 | `sbe-0.4.0-windows-x64.msi` |
...
For manual Release workflow runs, enter the version as `0.3.0`. The workflow also normalizes `v0.4.0`, but the final GitHub Release tag must be exactly `v0.4.0`, not `vv0.3.0`.
