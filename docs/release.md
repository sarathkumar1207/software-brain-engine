...
For manual Release workflow runs, enter the version as `0.3.0`. The workflow also normalizes `v0.5.0`, but the final GitHub Release tag must be exactly `v0.5.0`, not `vv0.3.0`.
